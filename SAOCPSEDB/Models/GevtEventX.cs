...
public partial class GevtEventX
{
    ...
    public int? Fbpersonresponsiblehrid { get; set; }
    ...
    public virtual ICollection<GevtAggressionassaultX> GevtAggressionassaultXes { get; set; } = new List<GevtAggressionassaultX>();

    public virtual ICollection<GevtAggressorX> GevtAggressorXes { get; set; } = new List<GevtAggressorX>();

    public virtual ICollection<GevtDocumentX> GevtDocumentXes { get; set; } = new List<GevtDocumentX>();

    public virtual GevtEventGuestX? GevtEventGuestX { get; set; }

    public virtual ICollection<GevtEventsubtypeX> GevtEventsubtypeXes { get; set; } = new List<GevtEventsubtypeX>();

    public virtual ICollection<GevtExposureppeX> GevtExposureppeXes { get; set; } = new List<GevtExposureppeX>();

    public virtual ICollection<GevtNotificationcontactX> GevtNotificationcontactXes { get; set; } = new List<GevtNotificationcontactX>();

    public virtual ICollection<GevtOthervehicleX> GevtOthervehicleXes { get; set; } = new List<GevtOthervehicleX>();

    public virtual ICollection<GevtPdfX> GevtPdfXes { get; set; } = new List<GevtPdfX>();

    public virtual ICollection<GevtPersoninvolvedX> GevtPersoninvolvedXes { get; set; } = new List<GevtPersoninvolvedX>();

    public virtual ICollection<GevtPsychinvolveX> GevtPsychinvolveXes { get; set; } = new List<GevtPsychinvolveX>();

    public virtual ICollection<GevtSecuritycontrolX> GevtSecuritycontrolXes { get; set; } = new List<GevtSecuritycontrolX>();

    public virtual ICollection<GevtSecuritytypeX> GevtSecuritytypeXes { get; set; } = new List<GevtSecuritytypeX>();

    public virtual ICollection<GevtSleeptypeX> GevtSleeptypeXes { get; set; } = new List<GevtSleeptypeX>();

    public virtual GevtStatusX? GevtStatusX { get; set; }

    public virtual GevtVehicleX? GevtVehicleX { get; set; }

    public virtual ICollection<GevtVehiclecollisionX> GevtVehiclecollisionXes { get; set; } = new List<GevtVehiclecollisionX>();

    public virtual ICollection<GevtVehicleinvolvedX> GevtVehicleinvolvedXes { get; set; } = new List<GevtVehicleinvolvedX>();

    public virtual ICollection<GevtWitnessX> GevtWitnessXes { get; set; } = new List<GevtWitnessX>();
}
